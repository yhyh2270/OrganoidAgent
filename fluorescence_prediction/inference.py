...
class OrganoidPredictor:
    ...
    def predict(self, data: bytes, language: str = "en") -> Prediction:
        self.load()
        ...
        if language == "zh":
            ...
            level, summary = "High viability", "The model places this organoid in the high-viability range."
        elif value >= 0.60:
            level, summary = "Intermediate viability", "The model places this organoid in the intermediate-viability range."
        else:
            level, summary = "Low viability", "The model places this organoid in the low-viability range."
