...
def plot_group(rows: list[dict], out_dir: Path, group_name: str, specs: list[tuple[str, str, str | None]]) -> tuple[Path, Path]:
    ...
    title_map = {
        'growth_full': 'App65 10x Replicates: Growth Metrics (Full)',
        'fusion_core_full': 'App65 10x Replicates: Fusion Metrics (Core)',
        'fusion_internal_edge_full': 'App65 10x Replicates: Fusion Metrics (Internal Edge)',
        'differentiation_full': 'App65 10x Replicates: Differentiation Metrics (Full)',
        'helpers_full': 'App65 10x Replicates: Helper / Normalization Metrics',
    }
    ...
    png = out_dir / f'app65_all_conditions_{group_name}.png'
    pdf = out_dir / f'app65_all_conditions_{group_name}.pdf'
